...
public class Reporter extends GenericLibrary
{
	...
	public final void ReportStep(String sStepDescription, String sExpectedResult, String sActualResult, String sStepStatus)
	{
		...
		oReportWriter.write("<TD class='tdborder_1'  align='cent er'>" + ++iStepCount + "</TD>");
	...
	public final void StartReportFileFormatting()
	{
		...
		String sReportFileName = dicConfig.get("ReportPath").toString() + "\\LastRun\\" + GenericLibrary.strCurrentTestCaseFormattedName + "_" + cal.get(Calendar.DAY_OF_MONTH) + "_" + cal.get(Calendar.MONTH) + "_" + cal.get(Calendar.YEAR) + "_" + cal.get(Calendar.HOUR_OF_DAY) + "H_" + cal.get(Calendar.MINUTE) + "M_" + cal.get(Calendar.SECOND) + ".html" ;
	...
	public final void FormatReportFile()
	{
		...
		oReportWriter.write(" <TD class='tdborder_1'  vAlign=center  align=middle >" + dicCommon.get("BrowserName") +"</TD>");
	...
	public final void EndReportFileFormatting()
	{
		...
		oReportWriter.write("<table cellSpacing='0' cellPadding='0' border='0' align='center' style='width:96%; " + " margin-left:5px;'>");
		...
		oReportWriter.write("<TD class='tdborder_1'  align='center'>" + dicCommon.get("BrowserName") + "</TD>");
		//oReportWriter.write("<TD class='tdborder_1'  align='center'>" + dicCommon.get("BrowserName") + "<br> Version( " + GetBrowserVersion()  + "</TD>");
...
//				reader.setCellData(strCurrentTestSet, "Html Reports Link", rowNum, htmlreportLink, htmlreportLink); //TODO : Mandeep : Check why this is corrupting the file.
	...
	public final String SaveScreenShot(String sSscreenshotFileName)
	{
		try
		{
			...
			FileUtils.copyFile(screenshot, new File(dicConfig.get("ReportPath").toString() + "\\LastRun\\" + sSscreenshotFileName));
...
//ORIGINAL LINE: public string SaveDeskTopScreen(string sSscreenshotFileName = "")
	public final String SaveDeskTopScreen(String sSscreenshotFileName)
	{
		try
		{
			...
			ImageIO.write(image, "png", new File(dicConfig.get("ReportPath").toString() + "\\LastRun\\" + sSscreenshotFileName));
		}
		catch (Exception e)
		{
			sSscreenshotFileName = "";
