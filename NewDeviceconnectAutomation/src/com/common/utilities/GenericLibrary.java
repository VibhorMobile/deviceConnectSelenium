...
public class GenericLibrary
{
	...
	public static ArrayList<String> devicesSelected = new ArrayList<String>();
	...
	public static FileWriter oAPIReportWriter;
	...
	public static int iApiPassStepCount;
	public static int iApiFailStepCount;
	...
	public static class Action
	{
		...
		public static String copyToClipbord = "copyToClipbord";
		public static String setText = "setText";
		...
		public static String explicitclick = "ExplicitClick";
		public static String UploadApplication="uploadapplication";
		public static String PressEnter = "pressEnter";
		public static String PressEsc="pressEsc";
		public static String UploadAngryBirdApp="uploadangrybirdapp";
		public static String UploadUserList="uploaduserlist";
		public static String CtrlPlusEnter="ctrlenter";
		...
		public static String SelectSupportWindow="selectsupportwindow";
		public static String AboutAppDistribution="aboutappdistribution";
		public static String SelectNewWindow="selectnewwindow";
		...
		public static String WindowHandles = "windowhandles";
	}
	...
	private static class Events
	{
		...
		public final boolean ExplicitClick(String ele)
		{
			boolean flag = false;
			element.click();
			wait = new WebDriverWait(driver,1);
			flag = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(dicOR.get(ele)))) != null;
			return flag;
		}
		
		public final boolean setText(String copyvalue)
		{
			boolean flag = false;
			try
			{
				copyToClipbord(copyvalue);
				element.click();
		...
		public final boolean copyToClipbord(String copyTo)
		{
			boolean flag = false;
			try
			{
		...
		public final Boolean UploadApplication(String appname)
		{
			...
			try
			{
				StringSelection stringSelection = new StringSelection(dicConfig.get("Artifacts") +"\\Applications\\"+appname);
	            ...
	            Thread.sleep(4000);
	            if(dicCommon.get("BrowserName").toLowerCase().equals("firefox")||dicCommon.get("BrowserName").toLowerCase().equals("ie"))
	            {
	               Thread.sleep(2000);
	            }
	            flag=true;
			...
			try
			{
				...
				try
				{
					if (!dicCommon.get("BrowserName").toLowerCase().equals("ie"))
					{
						...
						if (GenericLibrary.IEversion.equals("11"))
						{
							genericLibrary.PerformAction("", Action.WaitForElement,"3");
						}
					}
				}
				catch(Exception e)
		...
		public final boolean sendkeys(String strKeyword)
		{
			boolean flag = false;
			try
			{
		...
		public final boolean WaitForReady()
		{
			...
			try
			{
				String readyState = (String) ((org.openqa.selenium.JavascriptExecutor)GenericLibrary.driver).executeScript("if (document.readyState) return document.readyState;");
		...
		public final Boolean UploadApplication()
		{
			...
			try
			{
				StringSelection stringSelection = new StringSelection(dicConfig.get("Artifacts") +"\\com.aldiko.android.apk");
	            Toolkit.getDefaultToolkit().getSystemClipboard().setContents(stringSelection, null);
	            Robot robot = new Robot();
	            robot.keyPress(KeyEvent.VK_CONTROL);
	            robot.keyPress(KeyEvent.VK_V);
		...
		public final Boolean UploadUserList(String file)
		{
			boolean flag = false;
			try
			{
				...
				StringSelection stringSelection = new StringSelection(dicConfig.get("Artifacts") +"\\"+file);
	            Toolkit.getDefaultToolkit().getSystemClipboard().setContents(stringSelection, null);
	            Robot robot = new Robot();
	            Thread.sleep(2000);
	            robot.keyPress(KeyEvent.VK_CONTROL);
		...
		public final Boolean CtrlPlusEnter()
		{
			boolean flag=false;
			try
			{
		...
		public final Boolean Tab()
		{
			...
			try
			{
				...
				String keysPressed =  Keys.chord(Keys.TAB);
				element.sendKeys(keysPressed) ;
		...
		*/
		...
		public final String GetValue()
		{
			...
			try
			{
				...
				//strElementValue = element.getAttribute("innerHTML");
	...
	public static class Browser
	{
		...
		public final boolean PerformActionOnBrowser(String strAction, String strValue)
		{
			...
			switch (strAction.toLowerCase())
			{
				...
				case "selectwindow":
					...
					break;
				case "selectsupportwindow":
					flag=SelectSupportWindow(strValue);
					break;
				case "aboutappdistribution":
					flag=AboutAppDistribution(strValue);
					break;
				case "selectnewwindow":
					flag=SelectNewWindow(strValue);
					break;
		...
		//---------------------------------------------------------------------------------------//
		private boolean SelectWindow(String strWindowTitle)
		{
			boolean flag = false;
			String childWindow = strWindowTitle;
			driver.switchTo().window(childWindow);
			String currentTitle = driver.getCurrentUrl();
			if(currentTitle.contains("mobilelabsinc.com"))
			{
				flag = true;
			}
			return flag;
		...
		private boolean SelectSupportWindow(String strWindowTitle)
		{
			boolean flag = false;
			String childWindow = strWindowTitle;
			driver.switchTo().window(childWindow);
			String currentTitle = driver.getCurrentUrl();
			if(currentTitle.contains("https://mobilelabs.zendesk.com/"))
			{
				flag = true;
			}
			return flag;
		...
		private boolean AboutAppDistribution(String strWindowTitle)
		{
			boolean flag = false;
			String childWindow = strWindowTitle;
			driver.switchTo().window(childWindow);
			String currentTitle = driver.getCurrentUrl();
			if(currentTitle.equals("https://developer.apple.com/library/content/documentation/IDEs/Conceptual/AppDistributionGuide/Introduction/Introduction.html"))
			{
				flag = true;
			}
			return flag;
		...
		private boolean SelectNewWindow(String strWindowTitle)
		{
			boolean flag = false;
			String childWindow = strWindowTitle;
			driver.switchTo().window(childWindow);
		...
		//----------------------------------------------------------------------------------------//
			...
			private boolean WindowHandles(String strValue)
			{	
				boolean flag = false;
				strErrMsg_GenLib = "";
				try
				{
					...
					if (currentTitle.contains(strValue))
					{
						driver.close();
				...
				{
					flag = false;
					strErrMsg_GenLib = "WindowHandles() -- " + e.getStackTrace();
					genericLibrary.writeToLog(strErrMsg_GenLib);
				}
	           return flag;
			}
...
//ORIGINAL LINE: public bool WaitTillProcessStarts(string strProcessName, int iTimeout = 30)
	...
	public void waitForPageLoaded() {
		...
		strErrMsg_GenLib = error.getMessage();
		}
		}
	...
	public final boolean KillObjectInstances(String ProcessName)
	{
		boolean flag = false;
		try 
		{
	...
	//Close the child windows popups...
	public final boolean CloseWindow(String ProcessName) 
	{
		boolean flag = false;
	  try
      {
		...
		{
			flag = false;
			writeToLog("CloseWindow--" + e.getStackTrace());
...
//ORIGINAL LINE: public void LaunchWebDriver(string strBrowser = "", string strURL = "")
		...
		try
		{
			switch (strBrowser.toString().toLowerCase())
			{
				...
				case "firefox":
					...
					break;
				case "ie":
					//KillObjectInstances("IEDriverServer.exe");
					//KillObjectInstances("iexplore");
					System.setProperty("webdriver.ie.driver", GenericLibrary.dicConfig.get("Artifacts") + "/IEDriverServer.exe");
					...
					IEversion = caps.getVersion().toString();
					break;
				case "chrome":
	...
	*/
	...
	public final boolean PerformAction(WebElement element, String strAction)
	{
		return PerformAction("", element, strAction, "");
	}
	
	public final boolean PerformAction(String strObjectName, String strAction, String strValue)
	{
		return PerformAction(strObjectName, null, strAction, strValue);
	}

//ORIGINAL LINE: public bool PerformAction(string strObjectName, string strAction, string strValue = "")
	public final boolean PerformAction(String strObjectName, WebElement givenElement, String strAction, String strValue)
	{
		System.out.println();
		boolean flag = false;
		try
		{
			...
			{	
				...
				if (element == null)
				{
					...
					if (!((strAction.toLowerCase().equals("waitforelement")) || (strAction.toLowerCase().equals("isnotdisplayed")) ||(strAction.toLowerCase().equals("uploaduserlist"))|| (strAction.toLowerCase().equals("uploadapplication"))))
						return false;
				}
				...
				switch (strAction.toLowerCase())
				{
					case "click":
						...
						break;
					case "copyToClipbord" :
						flag = events.copyToClipbord(strValue);
					case "setText" :
						flag = events.setText(strValue);
					case "explicitclick":
						flag = events.ExplicitClick(strValue);
						break;
					case "exist":
						flag = true;
						break;
					case "sendkeys":
						flag = events.sendkeys(strValue);
						break;
					case "type":
					...
					case "isnotselected":
						...
						break;
					case "doubleclick" :
						flag = events.DoubleClick();
						break;
					case "waitforready":
						flag=events.WaitForReady();
						break;
					case "pressenter":
						events.PressEnter();
						break;
					...
					case "uploadapplication":
						...
						{
							flag=events.UploadApplication(strValue);
						}
						else
						{
							flag=events.UploadApplication();
						}
						break;
					case "uploaduserlist":
						flag=events.UploadUserList(strValue);
						break;
					case "ctrlenter":
						flag=events.CtrlPlusEnter();
						break;
					case "tab":
						flag=events.Tab();
						break;
	...
	*/
	public final String GetTextOrValue(String strObject, String strAction)
	{
		return GetTextOrValue(strObject,null, strAction);
	}
	
	public final String GetTextOrValue(WebElement givenElement, String strAction)
	{
		return GetTextOrValue(strObject, givenElement, strAction);
	}
	
	public final String GetTextOrValue(String strObject)
	{
		return GetTextOrValue(strObject, null, "");
	}
	
	public final String GetTextOrValue(String strObject, WebElement givenElement, String strAction)
	{
		WebElement ele;
		String value = "";
		if(givenElement==null)
		{
			ele = GetElement(strObject);
		}
		else
		{
			ele = givenElement;
		...
		try
		{
			if (!dicCommon.get("BrowserName").toLowerCase().equals("ie") && (IEversion.equals("11")))
			{
		...
		//WebElement element = GetElement(strObject);
		
		try
		{
			if (ele != null)
			{
				Events events = new Events(ele);
				if(strAction=="")
				{
					strAction = "text";
				}
			...
			{
				strErrMsg_GenLib = "Element " + ele + " is not found on page";
				throw new RuntimeException("Element " + ele + " is not found on page - " + strErrMsg_GenLib);
			}
		}
		catch(RuntimeException e)
		{
	...
	public final String GetSelectedDropDownValue(String strObjectName)
	{
		try
		{
			if (!dicCommon.get("BrowserName").toLowerCase().equals("ie") && (IEversion.equals("11")))
	...
	*/
	...
	public final String getAttribute(WebElement givenElement, String strAttributeName, String cssPropertyName)
	{
		return getAttribute(strObject, givenElement, strAttributeName, cssPropertyName);
	}
	
	public final String getAttribute(String strObject, String strAttributeName,String cssPropertyName)
	{
		return getAttribute(strObject, null, strAttributeName, cssPropertyName);
	}
	
    //ORIGINAL LINE: public string getAttribute(string strObject, string strAttributeName, string cssPropertyName = "")
	public final String getAttribute(String strObject, WebElement givenElement, String strAttributeName, String cssPropertyName)
	{
    ...
    //ORIGINAL LINE: public string getAttribute(string strObject, string strAttributeName, string cssPropertyName = "")
	public final String getTitleAttributeValue(String strObject)
	{
		String strAttributeValue = null;
		...
		try
		{
			if (ele != null)
			{
					...
					try
					{
						strAttributeValue = ele.getAttribute("title");
					}
					catch (RuntimeException e)
					{
						throw new RuntimeException("Attribute - title is not found for object " + strObject);
					}
	...
	public final String getText(String strObject)
	{
		String strText = null;
		try
		{
	...
	public final Boolean setStartDate(String date) throws ParseException
	{
		
		String [] dd=date.split("-");
		if(dd[2].indexOf("0")==0)
		{
			dd[2]=dd[2].substring(1);
		}
		PerformAction("browser","waitforpagetoload");
		if(dd[2].contains("01") || dd[2].contains("02"))
		{
			PerformAction("previousmonthLocator",Action.Click);
		}
		PerformAction((dicOR.get("datelocator").replace("_date_", dd[2])), Action.Click);
		return true;
	}
	
	public final List<String> getUsageColumnValues(String element)
	{
		...
		{
			waitForPageLoaded();
			if(PerformAction("FirstUsagePagebtn",Action.isDisplayed))
			{
				PerformAction("FirstUsagePagebtn",Action.Click);
				waitForPageLoaded();
				PerformAction("browser","waitforpagetoload");
			}
			do
			{
				...
				{
					waitForPageLoaded();
					PerformAction("NextUsagePagebtn",Action.Click);
					waitForPageLoaded();
					PerformAction("browser","waitforpagetoload");
				}
				List<WebElement> elelist = driver.findElements(By.xpath(dicOR.get(element)));
				for(WebElement ele:elelist)
				{
					li.add(ele.getText());
				}
				count++;
			}while(PerformAction("NextUsagePagebtn",Action.isDisplayed));
		}
		catch (RuntimeException e)
		{
			strErrMsg_GenLib = e.getMessage();
	...
	public final List<String> getHistoryFirstLastPageColumnValues(String element)
	{
		List<String> li=new ArrayList<String>();
		int count=0;
		try
		{
			...
			do
			{
				...
				{
					waitForPageLoaded();
					PerformAction("Lastbtn",Action.Click);
					waitForPageLoaded();
					PerformAction("browser","waitforpagetoload");
				}
				List<WebElement> elelist = driver.findElements(By.xpath(dicOR.get(element)));
				...
				count++;
			}while(PerformAction("Lastbtn",Action.isDisplayed));
		}
		catch (RuntimeException e)
		{
			strErrMsg_GenLib = e.getMessage();
	...
	public final List<String> getColumnsValue(String element) throws InterruptedException
	{
		List<String> li=new ArrayList<String>();
		try
		{
			Thread.sleep(500);
			if(dicOR.containsKey(element))
			{
				element=dicOR.get(element);
			}
			List<WebElement> elelist = driver.findElements(By.xpath(element));
			for(WebElement ele:elelist)
			{
				li.add(ele.getText());
			}
	...
	*/
	...
	public final void CallTestScript()
	{
		...
		{
			writeToLog("CallTestScript() -- " + e.getStackTrace().toString());
		}
	}
...
//ORIGINAL LINE: public bool DeleteFilesFromDirectory(string FileNameWithPath, string FileOrFolder = "file")
	...
	*/
	...
	public final void DeleteCookies(String strBrowserName) throws RuntimeException
	{
		strErrMsg_GenLib = "";
		try
		{
			if (dicCommon.get("BrowserName").equalsIgnoreCase("ie"))
			{
				
				Runtime.getRuntime().exec("RunDll32.exe InetCpl.cpl,ClearMyTracksByProcess");
			}
		}
		/*catch (RuntimeException e)
		{
		...
		{
			strErrMsg_GenLib = "DeleteCookies() -- " + e.getStackTrace()[0].getLineNumber();
	...
	*/
	...
	public final boolean selectDeviceFromDropDown(String deviceDropdown)
	{
		boolean value = false;
		WebElement element = GetElement(deviceDropdown);
		List<WebElement> devices = element.findElements(By.tagName("option"));
		int size = devices.size();
		if  (size!=0)
		{
			Select selectdevice = new Select(element);
			selectdevice.selectByIndex(2);			
		}
		value = true;
		return value;
	}
	
	public final boolean MoveFilesToAnotherDirectory(File sourceDir, File destinationDir, String[] fileTypes, boolean createDestinationDirectory)
    {
           boolean flag = false;
           try
           {
              Iterator<File> itrLastRunFiles = FileUtils.iterateFiles(sourceDir, fileTypes, false);
              File currentFile;
              while(itrLastRunFiles.hasNext())
              {
                    currentFile = itrLastRunFiles.next();
                    FileUtils.moveFileToDirectory(currentFile, destinationDir, createDestinationDirectory);
              }
              flag = true;
           }
           catch(Exception e)
	...
	public final int get12HourTime_in_Format(String hour)
	{
		int time_hour=0;
		switch(hour)
		{
		...
		case "24":
			...
			default:
				time_hour=Integer.parseInt(hour);
				break;
		}
		return time_hour;
	}
	
	public final boolean UnHandeledException()
	{
		boolean flag  = false;
		flag = PerformAction("//div[contains(@class,'error')]//button[@class='close proper-close tr5']", Action.Click);
		return flag;
	...
	public  String getDays(String val)
	{
		 DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
		 //get current date time with Date()
		 Calendar cal = Calendar.getInstance();
	...
	public  String getDateFormat(String val) throws ParseException
	{
		DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
		String value="";
	...
	public static  String getDateFormat(Date date1) throws ParseException
	{
		DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
	...
	public static Date getAppUploadDateFormat(String val) throws ParseException
	{
		Date date=new Date();
	...
	public static Date getReservationDateFormat(String val) throws ParseException
	{
		Date date=new Date();
	...
	public Boolean verifyDateInRange(String dt, String rg1, String rg2) throws ParseException
	{
		DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
		Date date=dateFormat.parse(dt);
		Date datestart=dateFormat.parse(rg1);
		Date dateEnd=new Date();
		if(rg1.equals(rg2))
		{
			Calendar cal = Calendar.getInstance();
			dateEnd=dateFormat.parse(dateFormat.format(cal.getTime()));
		}
		else
		{
			dateEnd=dateFormat.parse(rg2);
		}
	...
	public Boolean verifyDatesnDevice(String dt, String rg1) throws ParseException
	{
		DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
		Date date=dateFormat.parse(dt);
		Date dateEnd=dateFormat.parse(rg1);
	...
	public Boolean verifylastupdateDateisTodays_Date(String val)
	{
		try
		{
			DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
			...
			Calendar cal = Calendar.getInstance();
			Date dateEnd=dateFormat.parse(dateFormat.format(cal.getTime()));
			if(date.compareTo(dateEnd)==0)
			{
				return true;
			}
	...
	public static Boolean updateCSV(String fileToUpdate, String replace,int row, int col) throws IOException
	{
		Boolean flag=false;
		...
		try
		{
			...
			csvBody.get(1)[20] = null;
			csvBody.get(1)[21] = null;
			csvBody.get(1)[22] = null;
			reader.close();
	...
	public static Boolean updateCSVForImporting2User(String fileToUpdate, String replace,int row, int col) throws IOException
	{
		Boolean flag=false;
		...
		try
		{
			...
			csvBody.get(1)[21] = null;
			csvBody.get(1)[22] = null;
			csvBody.get(2)[20] = null;
			csvBody.get(2)[21] = null;
			csvBody.get(2)[22] = null;
			reader.close();
	...
	public String getMonth(String val) throws ParseException
	{
		switch(val)
		{
		case "01":
	...
	*/
	...
	/** 
	 Verifies if the file downloaded.
	 <pre>
	</pre> 
	...
	*/
	...
	/*<!--Created by : Vinita Mahajan -->
	 <!--Last updated :-->
	 @param 
	 @return datetime by adding/subtracting number of days provided
	*/
	public String addDays(Date d, int days,String format)
    {
	        ...
	        String FormatedTime = format1.format(c.getTime());  // returns new date object, number of hours provided (in the future)
			return FormatedTime;
	...
	/*<!--Created by : Vinita Mahajan -->
	 <!--Last updated :-->
	 @param TimeFormat HH:mm:ss, hh:mm
	 @return time by adding/subtracting number of hours provided
	*/
	public String addTime(Date d, int hours,String TimeFormat)
	{
		...
		//if need to get the current time & then add hours to it just use - cal.setTime(new Date());
		cal.setTime(d); // sets calendar time/date
		cal.add(Calendar.HOUR_OF_DAY, hours); // adds one hour
	 	SimpleDateFormat format = new SimpleDateFormat(TimeFormat);
        String FormatedTime = format.format(cal.getTime());  // returns new date object, number of hours provided (in the future)
		return FormatedTime;
	}
	...
	/*<!--Created by : Vinita Mahajan -->
	 ...
	 @return time by adding/subtracting number of hours provided
	*/
	public String addYears(Date d, int days,String format)
    {	
		Calendar c = Calendar.getInstance();
	...
	public String addDayofWeek(Date d, int day,String format)
	{
		Calendar c = Calendar.getInstance();
		if(d==null)
		{
        ...
        String FormatedDay = Sformat.format(c.getTime());  // returns new date object, number of hours provided (in the future)
		return FormatedDay;
	}
	
	/** 
	 This function will return user id from URL
