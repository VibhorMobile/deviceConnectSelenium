...
public static boolean readTxtFile(String filepath) throws Exception 
{
	...
	while ((sCurrentLine = br.readLine()) != null)
	{
		...
		if(filepath.contains("UserInformationJson.json") && sCurrentLine.contains("["))
		{
			return flag=true;
		}
		if(filepath.contains("UserInformationList.txt") && !sCurrentLine.contains("["))
		{
			return flag=true;
		}
		if(filepath.contains("UserInformationCSV.csv") && sCurrentLine.contains("\"Email\",\"IsActive\","))
		{
			return flag=true;
		}
		if(filepath.contains("DeviceLogs.txt") && sCurrentLine.length()>0)
		{
			return flag=true;
		}
