...
//		String droptionOptionXpathAvailable = "";
//		String droptionOptionXpathInUse = "";
//		String droptionOptionXpathOffline= "";
//		String droptionOptionXpathDisabled= "";
...
////		
//		
//		dropdownButtonXpath = dicOR.get("Status_DevicesIndexPage").replace("__FILTER__", dropdown);
//		droptionOptionXpathDisabled = dicOR.get("eleDisabled_DevicesIndexPage").replace("__OPTION__", option).replace("__FILTER__", dropdownForXpath.toLowerCase());
//
...
//				else
//				{
//					strVerification = PerformAction(deletebtnXPath + "[" + i + "]", Action.isNotDisplayed);
//				}
...
//                        	actualValue = actualValue.split("%")[1].replace("(","").replace(")", "").replace("]", "").trim();
...
//                    status = status.replace("In Use", "In Use,Reserved");
...
//		 else
//		 {
//		  throw new RuntimeException("Could not click on Settings button.");
//		 }
//		 }
//		 else
//		 {
...
//}
//    
//  public final boolean VerifySorting(String TableContainerXpath, String columnNames)
//    {
//	  boolean flag = false;
...
//	{
//	  if(columnNameValues.get(i).getText().equals(columnName))
//	     {
//	       columntoclick = i+1;
//	       break;
//	     }
...
//	  flag = PerformAction(TableContainerXpath+dicOR.get("lnk_Name/StatusOnDevicesPage"), Action.Click);
