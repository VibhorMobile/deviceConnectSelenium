...
/*
 * JIRA ID --> QA-1053, QA-1415
 */

public class _483_Verify_history_for_the_specified_date_range_is_generated_by_using_d_to_and_from_arguments_together extends ScriptFuncLibrary
{
	...
	public final void testScript() throws InterruptedException, IOException
	{
		...
		if (isEventSuccessful)
		{	
	     	 Values = ExecuteCLICommand("historydevicefromto", "iOS", EmailAddress, Password, "", "");
