...
public class _450_Verify_bulk_release_on_devices_list_filtered_on_the_basis_of_Platform_value extends ScriptFuncLibrary
{
	...
	public final void testScript()
	{
		...
		//**************************************************************************//
		// Step 3 : Select filter of Status : In Use and Platform : Android
		//**************************************************************************//
		...
		strstepDescription = "Verify bulk release on devices list filtered on the basis of Platform value.";
		strexpectedResult = "User should be able to release devices on the basis of Platform value.";
		
		if (isEventSuccessful)
		{
			strActualResult = "User is able to release devices on the basis of Platform value.";
		}
		else
		{
