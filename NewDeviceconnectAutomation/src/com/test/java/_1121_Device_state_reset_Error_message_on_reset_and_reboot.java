 ...
 * Creation Date: 27th Oct 2016
 * Last Modified Date: NA
 * Pre-requisite: Server should have atleast one device for all status
 * Jira Test Case Id: QA-1892
 * Coverage from Jira Case: Complete
 */
public class _1121_Device_state_reset_Error_message_on_reset_and_reboot extends ScriptFuncLibrary {
	...
	String entitlementMessage="User does not have required entitlement DeviceReboot";

	public void createAndexecuteCurlCommand(String deviceId, String action)
	{
		//creating curl command
		component="device";
		parameterList="verb,action,Id,reboot";
		valueList="action,"+action+","+deviceId+",true"; //declaration and intialization of curl command varaiables.
	...
	public final void testScript() throws InterruptedException, IOException
	{
		try{
			...
			apiReporter.apiScriptHeading("_1121_Device_state_reset_Error_message_on_reset_and_reboot--------------- QA:1892");
			isEventSuccessful = Login();
			isEventSuccessful=GoToUsersPage();
			String[]entitlement={"Device reboot"};
