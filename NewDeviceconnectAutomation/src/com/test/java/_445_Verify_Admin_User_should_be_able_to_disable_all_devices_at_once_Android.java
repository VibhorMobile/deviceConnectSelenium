...
public class _445_Verify_Admin_User_should_be_able_to_disable_all_devices_at_once_Android extends ScriptFuncLibrary
{
	...
	public final void testScript()
	{
		...
		//**************************************************************************//
		strstepDescription = "Verify Admin User should be able to disable all devices at once Android.";
		strexpectedResult = "Admin User should be able to disable all devices at once Android.";
		
		if (isEventSuccessful)
		{
			strActualResult = "All Android devices disabled.";
		}
		else
		{
