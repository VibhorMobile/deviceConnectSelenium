 ...
 * JIRA ID --> QA-1199
 */
public class _596_Verify_history_event_called_Device_Disabled_is_reported_after_disabling_a_non_disabled_device extends ScriptFuncLibrary
{
		...
		if(isEventSuccessful)
		{
			...
			if(isEventSuccessful)
			{
				...
				if(isEventSuccessful)
				{
					...
					if(Event.equalsIgnoreCase("Device Disabled") && EventDeviceName.equalsIgnoreCase(DeviceName))
					{
