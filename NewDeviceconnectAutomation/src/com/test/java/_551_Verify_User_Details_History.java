...
/*
 * JIRA ID --> QA-764, QA-474
 */

public class _551_Verify_User_Details_History extends ScriptFuncLibrary
{
	...
	public final void testScript()
	{
		...
		searchDevice_DI(dicCommon.get("EmailAddress"));
		...
		isEventSuccessful=GetTextOrValue("usersHeaderInfo", "text").equals("Deepak Solanki");
		if(isEventSuccessful)
		{
