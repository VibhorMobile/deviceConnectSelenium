...
public class _2014_Report_Usage_TakeSkip extends ScriptFuncLibrary {
	...
	public final void testScript()
	{
		try
		{
			...
			apiReporter.apiScriptHeading("_2014_Report_Usage_TakeSkip");
	        ...
	        System.out.println(oneDaysAgodt);
				...
				apiReporter.apiNewHeading("Skip and Take Usage");
...
//				String component= "Report", parameterList="type,"+reportFor+"Id,from,to", valueList="history,"+Id+","+apiMethods.convertDateLocalTimezoneToUTC(twoDaysAfterdt).replace(":", "%3A").replace(" ", "%20")+".000000Z,"+apiMethods.convertDateLocalTimezoneToUTC(todaydt).replace(":", "%3A").replace(" ", "%20")+".000000Z"; //declaration and intialization of curl command varaiables. 
		        ...
		        String component= "Report", parameterList="type,toDate,take", valueList="usage,"+oneDaysAgodt+",10"; //declaration and intialization of curl command varaiables.
				...
				//------------------------SKIP----------------------------------------------------------------------
				 	...
				 	valueList="usage,5,5,"+oneDaysAgodt; 
					...
					for (int recIt=1; recIt<=5; recIt++)
					{
						...
						actualResultMap=apiMethods.getKeyValuePair_Report(jsonResponseTake,recIt+5,"deviceUsage");
						expectedResultMap=apiMethods.getKeyValuePair_Report(jsonResponseSkip,recIt,"deviceUsage");
