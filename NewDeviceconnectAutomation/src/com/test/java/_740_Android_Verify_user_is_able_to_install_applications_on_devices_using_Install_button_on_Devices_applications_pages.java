...
/*
 * Jira Test Case Id: QA-358
 */
public class _740_Android_Verify_user_is_able_to_install_applications_on_devices_using_Install_button_on_Devices_applications_pages extends ScriptFuncLibrary
{
	...
	public final void testScript() throws InterruptedException, IOException
	{
        ...
        //Getting latest Android device available on the server
        ...
        if (isEventSuccessful)
        {
        	...
        	if (isEventSuccessful)
        	{
        		...
        		strActualResult="Unable to click on Install button on PhoneLookup (Android) app details page.";
        }
        else
        	strActualResult="Unable to navigate to PhoneLookup (Android) app details page.";
