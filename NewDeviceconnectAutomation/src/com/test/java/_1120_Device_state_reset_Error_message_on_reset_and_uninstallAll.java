 ...
 * Jira Test Case Id: QA-1894
 * Coverage from Jira Case: Complete
 */

public class _1120_Device_state_reset_Error_message_on_reset_and_uninstallAll extends ScriptFuncLibrary {
	...
	public void createAndexecuteCurlCommand(String deviceId, String action)
	{
		...
		component="device";
		parameterList="verb,action,Id,uninstallAll";
	...
	public final void testScript() throws InterruptedException, IOException
	{
		try{
			...
			apiReporter.apiScriptHeading("_1120_Device_state_reset_Error_message_on_reset_and_uninstallAll-------QA:1894");
