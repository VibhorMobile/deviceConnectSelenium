...
public class _2011_Report_Usage_SameDate extends ScriptFuncLibrary {
...
//	String reportOf[] = {"application","device","user"};
	...
	public final void testScript()
	{
		try
		{
			...
			apiReporter.apiScriptHeading("_2011_Report_Usage_SameDate");
			...
			for (String reportFor : reportOf)
			{
				...
				*/
				...
				//Set Customize date.
				isEventSuccessful=setCustomizedDates_SFL(todaydt,todaydt);
		        ...
		        String component= "Report", parameterList="type,"+reportFor+"Id,fromDate,toDate", valueList="usage,"+Id+","+todaydt+","+todaydt; //declaration and intialization of curl command varaiables.
