...
public class _488_Verify_entire_usage_printed_on_console_using_history_command_without_arguments extends ScriptFuncLibrary
{
	...
	public final void testScript() throws InterruptedException, IOException
	{
		...
		if (isEventSuccessful)
		{	
	     	 Values = ExecuteCLICommand("usage", "iOS", EmailAddress, Password, "", "");
