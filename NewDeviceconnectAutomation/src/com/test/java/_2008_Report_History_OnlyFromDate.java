...
public class _2008_Report_History_OnlyFromDate extends ScriptFuncLibrary {
...
//	String reportOf[] = {"application","device","user"};
	...
	public final void testScript()
	{
		try
		{
			...
			apiReporter.apiScriptHeading("_2008_Report_History_OnlyFromDate");
			...
			/*	
				String startDate=GetTextOrValue("//*[@id='actual-content-body']//table/tbody/tr[1]/td[1]", "text");
		        ...
		        String twoDaysAgodt = dateFormat.format(twoDayAgodate);
				...
				if(isEventSuccessful)
				{
					isEventSuccessful=setCustomizedDates(twoDaysAgodt,todaydt);
					if(isEventSuccessful)
					{
...
//				String component= "Report", parameterList="type,"+reportFor+"Id,from,to", valueList="history,"+Id+","+apiMethods.convertDateLocalTimezoneToUTC(twoDaysAgodt).replace(":", "%3A").replace(" ", "%20")+".000000Z,"+apiMethods.convertDateLocalTimezoneToUTC(todaydt).replace(":", "%3A").replace(" ", "%20")+".000000Z"; //declaration and intialization of curl command varaiables. 
		        ...
		        String component= "Report", parameterList="type,"+reportFor+"Id,fromDate", valueList="history,"+Id+","+twoDaysAgodt; //declaration and intialization of curl command varaiables.
