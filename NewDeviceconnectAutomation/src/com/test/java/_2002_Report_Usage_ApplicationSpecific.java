...
public class _2002_Report_Usage_ApplicationSpecific extends ScriptFuncLibrary {
...
//	String reportOf[] = {"application","device","user"};
	...
	public final void testScript()
	{
		try
		{
			...
			apiReporter.apiScriptHeading("_2002_Report_Usage_ApplicationSpecific");
			...
			for (String reportFor : reportOf)
			{
				...
				isEventSuccessful=apiMethods.verifyfieldsNotNullInAPIResponse(jsonResponse, "id,deviceId,deviceName,operatingSystem,operatingSystemVersion,startDate,endDate,duration,applicationId,applicationName", "usage");
