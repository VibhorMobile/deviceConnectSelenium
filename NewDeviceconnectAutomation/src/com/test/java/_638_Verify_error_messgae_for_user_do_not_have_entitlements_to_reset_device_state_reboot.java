...
/*
 * Jira Test Case Id: QA-1891
 */
public class _638_Verify_error_messgae_for_user_do_not_have_entitlements_to_reset_device_state_reboot extends ScriptFuncLibrary
{
	...
	public final void testScript() throws InterruptedException, IOException
	{
		...
		if (isEventSuccessful)
		{	
			Values = ExecuteCLIResetCommands("resetreboot", "iOS", testerEmailAddress, testerPassword, deviceName, "","");
			isEventSuccessful = (boolean)Values[2];
			outputText=(String)Values[0];
			if (isEventSuccessful && outputText.contains("User does not have required entitlement: DeviceReboot"))
			{
				strActualResult = "User does not have required entitlement: DeviceReboot";
			}
			else
			{
				strActualResult = "ExecuteCLICommand---" + strErrMsg_AppLib;
