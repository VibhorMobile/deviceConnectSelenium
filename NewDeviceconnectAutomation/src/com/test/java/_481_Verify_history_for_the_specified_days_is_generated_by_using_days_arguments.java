...
public class _481_Verify_history_for_the_specified_days_is_generated_by_using_days_arguments extends ScriptFuncLibrary
{
	...
	public final void testScript() throws InterruptedException, IOException
	{
		...
		if (isEventSuccessful)
		{	
	     	 Values = ExecuteCLICommand("historydays", "iOS", EmailAddress, Password, "", "");
		...
		reporter.ReportStep("History file generated using -days arguments" , "File should be created", strActualResult, isEventSuccessful);
		if (!isEventSuccessful)
		{
			return;
		}
