...
/*
 * JIRA ID --> QA-1195, QA-1299
 */

public class _484_Verify_usage_for_the_specified_date_range_is_generated_by_using_d_to_and_from_arguments_together extends ScriptFuncLibrary
{
	...
	public final void testScript() throws InterruptedException, IOException
	{
		...
		if (isEventSuccessful)
		{	
	     	 Values = ExecuteCLICommand("usagedevicefromto", "iOS", EmailAddress, Password, "", "");
		...
		reporter.ReportStep("Usage file generated using -from and -to arguments" , "File should be created", strActualResult, isEventSuccessful);
		if (!isEventSuccessful)
		{
			return;
		}
		...
		if(isEventSuccessful)
		{
			...
			if(isEventSuccessful)
			{
				strActualResult="Usage file for specified date range created";
			}
			else
			{
				strActualResult=strErrMsg_AppLib;
			}
			reporter.ReportStep("Verify usage file created for specified date range" , "Usage file should contain specified date range", strActualResult, isEventSuccessful);
		}
