...
public class _480_Verify_usage_for_the_specified_date_range_is_generated_by_using_to_and_from_arguments_together extends ScriptFuncLibrary
{
	...
	public final void testScript() throws InterruptedException, IOException
	{
		...
		if (isEventSuccessful)
		{	
	     	 Values = ExecuteCLICommand("usagefromto", "iOS", EmailAddress, Password, "", "");
		...
		if(isEventSuccessful)
		{
			...
			reporter.ReportStep("Verify usage file created for specified date range" , "Usage should contain specified date range", strActualResult, isEventSuccessful);
		}
