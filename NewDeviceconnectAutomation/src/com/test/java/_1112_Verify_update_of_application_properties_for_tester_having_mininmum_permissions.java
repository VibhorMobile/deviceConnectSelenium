 ...
 * Jira Test Case Id: QA-1865
 * Coverage from Jira Case: Complete
 */

public class _1112_Verify_update_of_application_properties_for_tester_having_mininmum_permissions extends ScriptFuncLibrary {
	...
	Object[]values;
	String appId,appName,appNameEdited;
	String errorMessage;
	String entitlementErrorExpected="User does not have required entitlement ApplicationModify";
	...
	public final void testScript() throws InterruptedException, IOException
	{
		try{
			...
			apiReporter.apiScriptHeading("_1112_Verify_update_of_application_properties_for_tester_having_mininmum_permissions");

			//Login to DC Server
			isEventSuccessful = Login();
			isEventSuccessful=GoToUsersPage();
			String[]entitlement={"Application modify"};
			...
			String component= "Application", parameterList="verb"+",id", valueList="update"+","+appId, dataTag="{displayName:\\\"" +appName+"_edited\\\"}"; //declaration and intialization of curl command varaiables.
			...
			if(appName.equals(appNameEdited)){
				strActualResult="Display Name for application "+appName+" is not edited";
				apiReporter.apiPassBlock("Display Name for application "+appName+" is not edited, display name at UI is:"+appNameEdited);
			}
			else{
				strActualResult="Display Name for application "+appName+" is edited to "+appNameEdited;
				apiReporter.apiErrorBlock("Display Name for application "+appName+" is edited to "+appNameEdited);
			}
