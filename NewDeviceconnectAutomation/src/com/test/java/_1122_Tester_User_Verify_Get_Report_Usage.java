 ...
 * Jira Test Case Id: QA-1906
 * Coverage from Jira Case: Complete
 */
public class _1122_Tester_User_Verify_Get_Report_Usage extends ScriptFuncLibrary {
	...
	public void createAndexecuteCurlCommand(String idType, String idValue)
	{
		...
		valueList="usage,"+idValue; //declaration and intialization of curl command varaiables.
	...
	public final void testScript() throws InterruptedException, IOException
	{
		try{
			...
			apiReporter.apiScriptHeading("_1122_Tester_User_Verify_Get_Report_Usage---------------QA:1906");
